...
public class HomeViewModel extends AndroidViewModel {
    ...
    //public LatLng ULP = new LatLng(-33.150720,-66.306864);

    public LatLng SANLUIS;
    ...
    public void obtenerUltimaUbicacion() {
        if (ActivityCompat.checkSelfPermission(context, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(context, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            return;
        } // Chequea si estan los permisos para que la proxima accion sea segura
        ...
        tarea.addOnSuccessListener(getApplication().getMainExecutor(), new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    mLocation.postValue(location);// cuando haya un dato lo va a mostrar. Es un dato no sincronico.
                }
            }
        });
    }
